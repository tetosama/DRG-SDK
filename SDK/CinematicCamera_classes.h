...
public:
	...
	struct FString                                     DefaultFilmbackPresetName;                                // 0x08B8(0x0010) (ZeroConstructor, Config)
	struct FString                                     DefaultLensPresetName;                                    // 0x08C8(0x0010) (ZeroConstructor, Config)
