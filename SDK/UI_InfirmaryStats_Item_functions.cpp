...
bool UUI_InfirmaryStats_Item_C::IsInteractable()
{
	...
	UUI_InfirmaryStats_Item_C_IsInteractable_Params params;
...
void UUI_InfirmaryStats_Item_C::OnCountChanged_Event(class UMissionStat** MissionStat, float* Value)
{
	...
	UUI_InfirmaryStats_Item_C_OnCountChanged_Event_Params params;
...
void UUI_InfirmaryStats_Item_C::OnMouseEnter(struct FGeometry* MyGeometry, struct FPointerEvent* MouseEvent)
{
	static auto fn = UObject::FindObject<UFunction>("Function UI_InfirmaryStats_Item.UI_InfirmaryStats_Item_C.OnMouseEnter");

	UUI_InfirmaryStats_Item_C_OnMouseEnter_Params params;
...
void UUI_InfirmaryStats_Item_C::OnMouseLeave(struct FPointerEvent* MouseEvent)
{
	static auto fn = UObject::FindObject<UFunction>("Function UI_InfirmaryStats_Item.UI_InfirmaryStats_Item_C.OnMouseLeave");

	UUI_InfirmaryStats_Item_C_OnMouseLeave_Params params;
	params.MouseEvent = MouseEvent;
...
void UUI_InfirmaryStats_Item_C::MissonStatUpdate(struct FString* StatTitle, struct FString* StatValue)
{
