...
public:
	...
	bool                                               Debug;                                                    // 0x0298(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	void MissonStatUpdate(struct FString* StatTitle, struct FString* StatValue);
