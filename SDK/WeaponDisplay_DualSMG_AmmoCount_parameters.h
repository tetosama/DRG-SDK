...
struct UWeaponDisplay_DualSMG_AmmoCount_C_SetClipCount_Params
{
	int*                                               Value;                                                    // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function WeaponDisplay_DualSMG_AmmoCount.WeaponDisplay_DualSMG_AmmoCount_C.SetTotalCount
struct UWeaponDisplay_DualSMG_AmmoCount_C_SetTotalCount_Params
{
	int*                                               Value;                                                    // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};
...
struct UWeaponDisplay_DualSMG_AmmoCount_C_ExecuteUbergraph_WeaponDisplay_DualSMG_AmmoCount_Params
{
